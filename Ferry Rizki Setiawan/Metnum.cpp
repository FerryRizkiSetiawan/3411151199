...
{
	int a,b,c;
	int fungsi_kal,turunan_kal,integral_kal,hasil;
	int pilih;
	Menu :
		system("cls");
		printf("\t-------------------------------\n");
	...
	switch(pilih)
	{
		...
		case 5:
			...
			turunan_kal =a/3;
			integral_kal =b/2;
			printf("\tIntegralnya adalah : %dx^3 + %dx^2 - %dx", turunan_kal,integral_kal,c);
			getch();
			goto Menu;
		break;
	}
